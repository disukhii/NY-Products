...
const Cart = () => {
  ...
  const removeItemsById = React.useCallback(
    id => {
      if (window.confirm('Ви точно хочете видалити це з корзини?')) {
  ...
  return (
    <div class="container container--cart">
      <div class={classNames('cart', { 'cart--empty': !itemsCount })}>
        {itemsCount ? (
          <React.Fragment>
            <div class="cart__top">
              ...
              <div onClick={clearCart} class="cart__clear">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
            ...
            <div class="cart__bottom">
              <div class="cart__bottom-details">
                <span>
                  Всього продуктів: <b>{itemsCount} шт.</b>
                </span>
                <span>
